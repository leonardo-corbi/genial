...
export function OrdemSection({ ativos, perfil }: OrdemSectionProps) {
  const [ordemValidada, setOrdemValidada] = useState<OrdemSchemaType | null>(
    null
  );
  ...
  function onSubmit(data: OrdemSchemaType) {
    setOrdemValidada(data);
  }

  function handleNovaAnalise() {
    setOrdemValidada(null);
    form.reset();
  }
                      ...
                      <Tooltip>
                        ...
                        <TooltipContent>
                          <p className="max-w-xs">
                            ...
                            mais estáveis
                            <br />
                            <strong>Médio:</strong> Equilíbrio entre risco e
                            retorno
                            <br />
                            <strong>Alto:</strong> Maior volatilidade, potencial
